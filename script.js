  ...
  if (button) {
    button.addEventListener("click", function() {
      ...
      if (nameValue === "" || emailValue === "") {
        ...
        alert("Akash bhai, email thoda galat lag raha hai. Sahi format dalo (jaise: example@gmail.com)! 📧❌");
      } 
      else {
...
}; // <-- YEH HAI SABSE MAIN BRACKET JO MISSING THA! (window.onload ka band hona)
